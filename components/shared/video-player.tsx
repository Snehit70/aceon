...
import { MediaPlayer, MediaProvider, Controls, PlayButton, TimeSlider, VolumeSlider, FullscreenButton } from "@vidstack/react";
  ...
  return (
    <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-2xl ring-1 ring-white/10 group">
      ...
      >
        ...
        <Controls.Root className="absolute inset-0 z-20 flex flex-col justify-between p-6 bg-gradient-to-t from-black/90 via-black/20 to-black/60 opacity-0 transition-opacity duration-300 group-hover:opacity-100 data-[paused]:opacity-100">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <PlayButton className="w-20 h-20 bg-white/10 hover:bg-white/20 backdrop-blur-xl rounded-full flex items-center justify-center text-white transition-all duration-300 hover:scale-110 pointer-events-auto ring-1 ring-white/20 shadow-2xl hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center gap-6">
                <PlayButton className="text-white/80 hover:text-white transition-all hover:scale-110">
              ...
              <FullscreenButton className="text-white/80 hover:text-white transition-all hover:scale-110">
