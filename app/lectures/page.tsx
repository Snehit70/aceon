        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 py-12 max-w-7xl space-y-16 relative z-10 animate-in fade-in duration-500">
          ...
          <div className="space-y-12">
            <div className="flex gap-8 border-b-4 border-neutral-800">
              <div className="h-12 w-56 border-b-4 border-[#E62E2D]/50 mb-[-4px] flex items-center">
                <div className="h-8 w-48 bg-neutral-800/50 animate-pulse" />
              </div>
              <div className="h-12 w-56 mb-[-4px] flex items-center">
                <div className="h-8 w-48 bg-neutral-900/30 animate-pulse" />
              </div>
            </div>
